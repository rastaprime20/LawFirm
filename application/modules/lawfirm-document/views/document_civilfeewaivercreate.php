                                ...
                                <ol>
                                    ...
                                    <li>                           
                                        <h4 style="display:inline;color:#4F5155">Your Job</h4>
                                                 <div class="form-horizontal ">
                                                    <div class="control-group ">
                                                        <label style="width:175px"class="control-label " for="focusedInput">If you have one<i>(job title):&nbsp;</i></label>
                                                        <div class="controls ">
                                                            <input class="input-xlarge focused " id="focusedInput" type="text">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-horizontal">
                                                    <div class="control-group">
                                                        <label class="control-label" for="focusedInput">Name of employer:</label>
                                                        <div class="controls">
                                                            <input class="input-xlarge focused" id="focusedInput" type="text">
                                                        </div>
                                                    </div>
                                        ...
                                        <ol>
                                            <li>
                                                <p>
                                                    ...
                                                    &nbsp;Yes<input type="radio"  value="option1" name="optionRadios" id="optionRadios1"> &nbsp;
                                                    No&nbsp; <input type="radio"  value="option2" name="optionRadios" id="optionRadios2">
                                                </p>
                                            </li>
                                            <li>
                                                <p>
