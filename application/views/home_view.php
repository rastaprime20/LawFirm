    ...
    <?php foreach ($client_list as $key => $client)
        { ?>
                                                                        <tr class="odd">
                                                                            ...
                                                                            <td class="center ">
                                                                                <a id="btnViewCase" class="btn btn-group input-prepend" name="viewCases[0]" title="View cases" data-rel="tooltip" href=<?php echo base_url(); ?>case/viewCase><i class="icon-eye-open icon-black"></i></a>
...
<?php echo form_error('txtnamedefendantsShortNamePresentBeneficiary', '<div style="margin-left:85px; width: 230px;" class="alert alert-error"><i class="icon-warning-sign icon-black"></i>', '</div>'); ?>
                                    ...
                                    <div class="span5">
                                        <br>
                                        <div class="input-prepend">
                                            <label for="txtnamedefendantsPresentBeneficiaryStreetAddressID"><span class="add-on" style="width:95px;"><div align="right">Address:</div></span><input style="width:190px;" title="Street Present Beneficiary Address" data-content="Example: 1120 N Street" name="txtnamedefendantsPresentBeneficiaryStreetAddress" id="txtnamedefendantsPresentBeneficiaryStreetAddressID" value="<?php echo set_value('txtnamedefendantsPresentBeneficiaryStreetAddress'); ?>"  type="text">
                                                <div class="clearfix" style="padding-top: 1px;">
...
<?php echo form_error('txtnamedefendantsShortNameForeclosureTrustee', '<div style="margin-left:85px; width: 230px;" class="alert alert-error"><i class="icon-warning-sign icon-black"></i>', '</div>'); ?>
                                    ...
                                    <div class="span5">
                                        <br>
                                        <div class="input-prepend">
                                            <label for="txtnamedefendantsForeclosureTrusteeStreetAddressID"><span class="add-on" style="width:95px;"><div align="right">Address:</div></span><input style="width:190px;" title="Street Foreclosure Trustee Address" data-content="Example: 1120 N Street" name="txtnamedefendantsForeclosureTrusteeStreetAddress" id="txtnamedefendantsForeclosureTrusteeStreetAddressID" value="<?php echo set_value('txtnamedefendantsForeclosureTrusteeStreetAddress'); ?>" type="text"/>
                                                <div class="clearfix" style="padding-top: 1px;">
    ...
    <script>
        $(document).ready(function() {
            $(function ()  
            {
                ...
                $('a[name="viewCases[0]"]').mouseenter(function(){                    
                    this.innerHTML = '<i class="icon-eye-open icon-black"></i> View Case';
                });
                $('a[name="viewCases[0]"]').mouseleave(function(){                    
                    this.innerHTML = '<i class="icon-eye-open icon-black"></i>';
                });
            });
        });
