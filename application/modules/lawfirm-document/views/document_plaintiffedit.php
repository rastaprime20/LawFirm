        ...
        <div class=span12>
            <ul class=breadcrumb>
                <li>
                    ...
                    <a href=<?php echo base_url(); ?>home/createDocument/editPlaintiff>Edit Plaintiff</a> <span class=divider>/</span>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="box span12">
                ...
                <div class="box-content" style="display: block;">
                    <form class ="form-horizontal">
                        <fieldset>
                            <legend>
                                <h4 style="color: #4F5155">Create Document - Edit Plaintiff Information</h4>
                            </legend> 
                    ...
                    <div class="modal-footer">
                        <a class="btn btn-primary" href="home/createDocument/plaintiff">Update</a>
