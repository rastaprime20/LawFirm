        ...
        <div class=span12>
            <ul class=breadcrumb>
                <li>
                    ...
                    <a href=<?php echo base_url(); ?>home/createDocument/createDefendant>Create Defendant</a> <span class=divider>/</span>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="box span12">
                ...
                <div class="box-content" style="display: block;">
                    <form class ="form-horizontal">
                        <fieldset>
                            <legend>
                                <h4 style="color: #4F5155">Create Document - Create Defendant Information</h4>
                            </legend> 
                    ...
                    <div class="modal-footer">
                        <input type="checkbox" name="checkbox2" id="checkbox2" /> Stay on this page after saving &nbsp;&nbsp; <a class="btn btn-primary" href="home/createDocument/createCivilCaseCoverSheet">Save & Next</a>
